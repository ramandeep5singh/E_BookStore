...
function checkInput(x){
    ...
    let addressIcon1 = document.getElementById("address-icon1");
    let addressIcon2 = document.getElementById("address-icon2");
    ...
    switch(x){
        ...
        case 4:
            if(address1.value == ""){
                address1.style.boxShadow = "0px 0px 10px 1px red";
                addressIcon1.style.boxShadow = "0px 0px 10px 1px red";
            }
            else{
                address1.style.boxShadow = "0px 0px 10px 1px green";
                addressIcon1.style.boxShadow = "0px 0px 10px 1px green"; 
            }
            break;
        
        case 5:
            if(address2.value == ""){
                address2.style.boxShadow = "0px 0px 10px 1px red";
                addressIcon2.style.boxShadow = "0px 0px 10px 1px red";
            }
            else{
                address2.style.boxShadow = "0px 0px 10px 1px green";
                addressIcon2.style.boxShadow = "0px 0px 10px 1px green"; 
            }
            break;
        case 6:
            if(password.value == ""){
...
function checkregistration(){
    ...
    if(name.value == "" || phone.value == "" || email.value == "" || addressIcon1.value == "" || addressIcon2.value == "" || password.value == "" || cPassword.value == ""){
        name.style.boxShadow = "0px 0px 10px 1px red";
        phone.style.boxShadow = "0px 0px 10px 1px red";
        email.style.boxShadow = "0px 0px 10px 1px red";
        address1.style.boxShadow = "0px 0px 10px 1px red";
