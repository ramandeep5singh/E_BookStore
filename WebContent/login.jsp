        ...
        <div class="card position-relative">
            ...
            <div id="customer-login" class="login position-absolute">
                <form class="position-relative" action="clogin" method="post" onsubmit="return checkCustomerInputs()">
                    <div class="form-input d-flex flex-column justify-content-center">
                        <div style="margin: 2vw 0;" class="d-flex justify-content-center">
                            <input type="text" name="customer-id" id="customer-input" placeholder="Enter User ID" onblur="checkLoginInput('21')">&nbsp<i class="fa-solid fa-user" id="customer-icon"></i>
                        </div>
                        <div class="d-flex justify-content-center">
                            <input type="password" name="customer-password" id="c-password" placeholder="Enter Password" onblur="checkLoginInput('22')">&nbsp<i class="fa-solid fa-lock" id="c-password-icon"></i>
                        </div>
                    </div>
                    <div class="form-button d-flex justify-content-center position-absolute">
                        <button type="submit">LOGIN</button>
