                ...
                <form class="position-relative" action="register" method="post" onsubmit="checkregistration()">
                    <div class="form-input d-flex flex-column justify-content-between">
                        ...
                        <div style="padding: 2vw 0;" class="d-flex justify-content-center">
                            <input type="password" name="confirm-password" id="c-password" placeholder="Confirm Password" onblur="checkInput(5)">&nbsp<i id="c-password-icon" class="fa-solid fa-lock"></i>
                        </div>
                    </div>
